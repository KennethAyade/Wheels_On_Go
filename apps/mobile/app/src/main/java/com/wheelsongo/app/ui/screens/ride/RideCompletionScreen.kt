                ...
                Column(modifier = Modifier.padding(16.dp)) {
                    ...
                    Row(
                        ...
                        Row(verticalAlignment = Alignment.CenterVertically) {
                            Text(
                                text = when (uiState.paymentMethod.uppercase()) {
                                    "GCASH" -> "GCash"
                                    "CREDIT_CARD" -> "Card"
                                    else -> "Cash"
                                },
                            ...
                            if (uiState.paymentStatus.equals("COMPLETED", ignoreCase = true)) {
